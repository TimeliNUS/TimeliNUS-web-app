          ...
          <v-list-item>
            <v-list-item-content>
              <v-list-item-title class="text-h6">
                <v-img src="@/assets/orbital_logo_latest.png" alt=""></v-img>
              </v-list-item-title>
            </v-list-item-content>
          </v-list-item>
        ...
        <div>
                  ...
                  <v-card-text>
                    <v-container>
                      <v-row>
                        ...
                        <v-col cols="12">
                          <v-text-field label="Module code"> </v-text-field>
                        </v-col>
                        <v-col cols="12" align="left">
                          <span>Groupmates</span>
                          <div
                            v-for="(user, index) in this.tempGroupmates"
                            :key="user.id"
                          >
                            <v-chip
                              class="ma-2"
                          ...
                          >
                            ...
                            <v-card>
                              ...
                              <v-card max-width="450" class="mx-auto" outlined>
                                <v-list>
                                  <v-list-item-avatar v-if="this.searchName"
                                    ><v-img :src="this.searchAvatar"></v-img>
                                  </v-list-item-avatar>
                                  {{ this.searchName }}
                                  <br />
                                  {{ this.searchEmail }}
          ...
          <div v-if="this.$store.getters.getProjects">
            <div
              ...
              :key="project.title"
            >
              <v-card max-width="800px" class="mx-auto pa-6" outlined>
                <v-row>
                  <v-col cols="12" md="3">
                      ...
                      <v-card>
                        ...
                        <v-card-actions>
                          ...
                          <v-btn
                            color="blue darken-1"
                            text
                            @click="display[project.title] = false"
                          >
                            Close
                          </v-btn>
                          <v-btn
