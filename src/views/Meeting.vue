        ...
        <v-row>
          <v-col col="12" md="4">
                          ...
                          >
                            ...
                            <span
                              style="
                                ...
                                padding-right: 12px;
                              "
                              >All participants will be required to import their
                              calendar or specify their available/occupied
                              timeslot in order to find the common available
                              time to create a meeting. Creators will be
                              required to select and confirm the meeting
                              timeslot after all participants have imported
                              their calendar.</span
                            >
                                  ...
                                  <v-row style="padding-top: 5px">
                                    ...
                                    Online Type*
                                        ...
                                        <small
                                          ...
                                          creation is online supported for Zoom
                                          now.</small
                                        >
                                      </div>
            ...
            >
              ...
              >
                <v-card-text
                  style="display: flex; font-size: 20px; font-weight: bold"
                >
                ...
                {{meeting.venue}} </span> -->
                      ...
                      <v-dialog
                        v-if="
                          ...
                          currSelectedPopupMeeting == meeting
                        "
                        v-model="currSelectedPopupMeeting"
                        content-class="elevation-0"
                        persistent
                        max-width="600px"
                        min-height="300px"
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              ...
                              >
                              <span
                                v-if="meeting.isOnlineVenue !== true"
                                style="
                                  padding: 5px;
                                  color: #4b4b4b;
                                  display: flex;
                                ...
                                <v-btn
                                  ...
                                  outlined
                                  small
                                  href="https://aces.nus.edu.sg/fbs/ADFSLogin"
                                  target="_blank"
                                  >NUS Facility Booking System</v-btn
                                ></span
                              >
                            </div>
                            <v-dialog
                              v-model="dialogNewLink[meeting.title]"
                              max-width="600px"
                              v-if="meeting.isOnlineVenue == true"
                            >
                              <template v-slot:activator="{ on, attrs }">
                                <v-btn
                                  ...
                                  color="#ff9d66"
                                >
                                  <v-icon rounded small>edit</v-icon>
                                  <span style="color: #ff9d66">
                                    Edit Meeting Link</span
                                  >
                                </v-btn>
                              </template>
            ...
            >
              ...
              >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <v-dialog
                            v-model="dialogNewLink2[meeting.title]"
                            max-width="600px"
                            v-if="meeting.isOnlineVenue == true"
                          >
                            <template v-slot:activator="{ on, attrs }">
                ...
                <div v-else>
                  <span
                    style="color: #4b4b4b; font-weight: bold; padding-top: 34vh"
                  >
                    You do not have any meeting yet. </span
                  ><br />
          ...
          <v-col col="12" md="8">
                                    ...
                                    >
                                      <v-btn
                                        ...
                                        @click="
                                          ...
                                          getBlockedTimeSlot(confirmation);
                                        "
                                      >
                                        View
                                      </v-btn>
                    ...
                    <v-col col="12" md="6">
                      ...
                      <v-card-actions>
                        ...
                        >
                          ...
                          <v-row style="margin-top: 5px; padding-left: 10px">
                            <span style="color: white; font-size: 14px"
                              >Save it as default calendar?</span
                            >
                            <v-switch
                              hide-details
                              :disabled="
                              ...
                              color="white"
                              v-model="assignExistingCalendarSwitch"
                            ></v-switch>
                          </v-row>
                        </v-radio-group>
                        <v-dialog
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <span style="margin-bottom: 10px; color: #4b4b4b"
                                >Calendar has been imported and uploaded to
                                server. Click "Done" button after you have
                                imported Google calendar (if any) and added
                                extra timeslot (if any) to confirm that you have
                                finished the importing process.
                              </span>
                              <v-btn
                                text
                                color="#ff9d66"
                        ...
                        <v-card-actions>
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                <span
                                  style="margin-bottom: 10px; color: #4b4b4b"
                                  >The dates and time of your busy events in
                                  Google calendar has been uploaded to the
                                  server. Click "Done" button after you have
                                  imported NUSMods calendar (if any) and added
                                  extra timeslot (if any) to confirm that you
                                  have finished the importing process.</span
                                >
                                <v-btn
                                  text
                                  color="#ff9d66"
                                ...
                                <div>
                                          ...
                                          >
                                            ...
                                            >
                                              ...
                                              <v-date-picker
                                                color="#ff9d66"
                                                :max="
                                                  currMeetingInv.displayMeetingDateRange.substr(
                                                    13
                                                  )
                                                "
                                                :min="
                                  ...
                                  <div>
                                    ...
                                    <div v-if="this.tempTimeslots.length !== 0">
                                      <div
                                        v-for="timeslot in orderedTimeslots"
                                        :key="timeslot.id"
                                      >
                                        <span
                                          >{{ timeslot.start.substr(0, 10) }}
                                          {{ timeslot.start.substr(10) }} -
                                          {{ timeslot.end.substr(10) }}</span
                                        >
                                        <v-btn
                                          icon
                                          color="#ff9d66"
                                  ...
                                  <v-card-actions>
                                    ...
                                    <v-btn
                                      color="#ff9d66"
                                      :disabled="this.tempTimeslots.length == 0"
                                      text
                                      @click="
                                        dialogExtraSlot = false;
                                        addTimeSlot();
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <span style="margin-bottom: 10px; color: #4b4b4b"
                              >Additional occupied timeslots have been added
                              successfully and uploaded to the server. Click
                              "Done" button after you have imported NUSMods
                              Calendar (if any) and Google calendar (if any) to
                              confirm that you have finished the importing
                              process.</span
                            >
                            <v-btn
                              text
                      ...
                      >
                        <v-btn
                          ...
                          @click="
                            doneMeetingInv();
                            doneMeetingDialog = true;
                          "
                        >
                          <span style="color: #ff9d66; font-weight: bold"
                            >Done and confirm</span
                          ></v-btn
                        >
                      </v-row>
                      <v-dialog
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <span style="margin-bottom: 10px; color: #4b4b4b"
                              >Import process has been done. The meeting will be
                              a pending meeting waiting for other groupmates to
                              complete the import process. It will be a meeting
                              confirmation otherwise waiting for confirming the
                              actual meeting date and time.</span
                            >
                            <v-btn
                              text
                              color="#ff9d66"
            ...
            <div v-if="currMeetingPending !== null">
              ...
              <v-card
                outlined
                color="#FFE4CB"
                style="max-height: 70vh; width: 100%; margin-bottom: 20px"
                :class="`rounded-xl`"
              >
                <div
                  style="
                      ...
                      >
                        <div
                          v-if="
                            ...
                            currMeetingConfirmation.creatorID
                          "
                        >
                          <v-row style="padding-left: 10px">
                            <v-card-title
                          ...
                          "
                              ...
                              <div
                                v-if="currMeetingConfirmation.venue == 'Zoom'"
                              >
                                <v-card-actions
                                  style="display: flex; flex-direction: column"
                                >
                                  <v-checkbox
                                    dark
                                    outlined
                                    v-model="automateZoomLink"
                                    @change="checkZoom()"
                                    label="Generate zoom link automatically"
                                  />
                                  <span
                                    v-if="
                                      automateZoomLink == true &&
                                      linkedToZoom == false
                                    "
                                    style="color: white"
                                  >
                                    You have not linked to zoom yet</span
                                  >
                                  <v-btn
                                    v-if="
                                      automateZoomLink == true &&
                                  ...
                                  >
                                    <span
                                      style="
                                        ...
                                        color: #4b4b4b;
                                      "
                                      >Meeting has been confirmed. It is added
                                      to the meeting calendar and meeting list
                                      on the left.</span
                                    >
                                    <v-btn
                                      text
                        ...
                        <div v-else>
                          <v-row style="padding-left: 10px">
                            <span style="color: white; font-weight: bold"
                              >Only the meeting creator can confirm the meeting
                              dates and time</span
                            >
                          </v-row>
                        </div>
...
export default {
  ...
  methods: {
          ...
          .update({
            timeslot: firebase.firestore.FieldValue.arrayUnion({
              start: firebase.firestore.Timestamp.fromDate(
                new Date(
                  this.tempTimeslots[i].start.substr(0, 10) +
                    "T" +
                    this.tempTimeslots[i].start.substr(10) +
                    ":00+08:00"
                )
              ),
              end: firebase.firestore.Timestamp.fromDate(
                new Date(
                  this.tempTimeslots[i].end.substr(0, 10) +
                    "T" +
                    this.tempTimeslots[i].end.substr(10) +
                    ":00+08:00"
                )
              ),
            }),
    ...
    async passinNewMeetingLink() {
      ...
      await db
        .collection("meeting")
        .doc(this.currSelectedPopupMeeting.id)
        .update({
    ...
    async addMeeting() {
      ...
      const response = await db.collection("meeting").add({
        ...
        timeslot: [],
        project: {
          id: this.meetingProject,
          title: projectTitle,
          reference: db.collection("project").doc(this.meetingProject),
        },
        ...
        .then((result) => {
          db.collection("user")
            ...
            .update({
              ...
              googleAccessTokenExpiry: firebase.firestore.Timestamp.fromMillis(
